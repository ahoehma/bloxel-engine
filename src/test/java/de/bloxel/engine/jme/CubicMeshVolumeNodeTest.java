...
public class CubicMeshVolumeNodeTest extends SimpleApplication implements ActionListener {
  ...
  private final LinkedBlockingQueue<AbstractVolumeNode> input = new LinkedBlockingQueue<AbstractVolumeNode>();
