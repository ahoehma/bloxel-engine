...
public class TextureAtlasProviderTest extends PowerMockTestCase {
  ...
  public void testLoading() throws Exception {
    ...
    assertEquals(textureAtlasProvider.getTextureCoordinates("grass"),
        of(Vector2f.ZERO, new Vector2f(0.0625f, 0), new Vector2f(0, 0.0625f), new Vector2f(0.0625f, 0.0625f)));
